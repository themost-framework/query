...
function QueryExpression()
{
    ...
    this.resolvingMember.subscribe(function (event) {
 ...
 */
 QueryExpression.prototype.getClosureParser = function() {
    ...
    // register sync hooks
    var self = this;
    closureParser.resolvingMember.subscribe(function(event) {
        var newEvent = {
            target: self,
            member: event.member
        };
        self.resolvingMember.emit(newEvent);
    ...
    closureParser.resolvingMethod.subscribe(function (event) {
        ...
        self.resolvingMethod.emit(newEvent);
...
/**
 * Initializes a union query expression with the specified query expression
 * @param {QueryExpression} expr
 * @returns this
 */
QueryExpression.prototype.union = function(expr) {
    if (this.$select == null) {
