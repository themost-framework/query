...
let LangUtils = require('@themost/common').LangUtils;
/**
 * @class
...
ArithmeticExpression.isArithmeticOperator = function(op) {
    if (typeof op === 'string')
...
LogicalExpression.isLogicalOperator = function(op) {
    if (typeof op === 'string')
...
ComparisonExpression.isComparisonOperator = function(op) {
    if (typeof op === 'string')
